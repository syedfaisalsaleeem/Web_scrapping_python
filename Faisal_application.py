...
def call_back():
    ...
    #input1=int(input("enter total number of pages"))
    #input2=input("enter the name of excel file for save")
    for line in range(entry1,entry2+1):
                fp = urllib.request.urlopen('https://nfs.punjab.gov.pk/?page='+str(line))# string contaneating with http and pasges entered
                mybytes = fp.read()
